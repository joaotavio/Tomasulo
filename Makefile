...
# chama o linker
tomasulo:  main.o tomasulo.o arquivo.o componente.o memoria.o instrucao.o util.o
	$(CC) main.o tomasulo.o arquivo.o componente.o memoria.o instrucao.o util.o -o tomasulo $(LDFLAGS)
